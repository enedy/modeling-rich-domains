...
namespace NerdStore.Catalago.Domain.Events
{
        ...
        INotificationHandler<PedidoProcessamentoCanceladoEvent>
    {
        ...
        public async Task Handle(ProdutoAbaixoEstoqueEvent mensagem, CancellationToken cancellationToken)
        {
            ...
            // ENVIAR UM E-MAIL OU SMS POR EXEMPLO, PARA AQUISIÇÃO DE MAIS PRODUTOS
        }
        ...
        public async Task Handle(PedidoIniciadoEvent message, CancellationToken cancellationToken)
        {
            ...
            if (result)
            {
                await _mediatorHandler.PublicarEvento(new PedidoEstoqueConfirmadoEvent(message.PedidoId, message.ClienteId, 
